...
class TransactionsApi
{
     ...
     *
     * @param  array $listLinks200ResponseLinksInner listLinks200ResponseLinksInner (required)
     * @param  string|null $uuid A transaction uuid (optional)
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return null|string|array
     *
     * @link https://api.accounting.sh/swagger.html#operation/addLink
     */
    public function addLink(
        array $listLinks200ResponseLinksInner,
        string|null $uuid = null,
    ): null|string|array {

        // verify the required parameter 'listLinks200ResponseLinksInner' is set
        if ($listLinks200ResponseLinksInner === null || (is_array($listLinks200ResponseLinksInner) && count($listLinks200ResponseLinksInner) === 0)) {
        ...
        $resourcePath = '/transactions/{uuid}/links';
        $queryParams = [];
        $headers = [];
        $options = [];
        ...
        $options['json'] = $listLinks200ResponseLinksInner;
     ...
     *
     * @param  string|null $uuid A transaction uuid (optional)
     * @param  string|null $linkUuid A transaction link uuid OR the target uuid (optional)
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return null|string|array
     *
     * @link https://api.accounting.sh/swagger.html#operation/deleteLink
     */
    public function deleteLink(
        string|null $uuid = null,
        string|null $linkUuid = null,
    ): null|string|array {



        $resourcePath = '/transactions/{uuid}/links/{link_uuid}';
        $queryParams = [];
        $headers = [];
        $options = [];
     ...
     * @param  string|null $account An account uuid to filter results (optional)
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return null|string|array
     *
     * @link https://api.accounting.sh/swagger.html#operation/ledger
     */
    public function ledger(
        ...
        $resourcePath = '/transactions/ledger';
        $queryParams = [];
        $headers = [];
        $options = [];
     ...
     * @return null|string|array
     *
     * @link https://api.accounting.sh/swagger.html#operation/listLinks
     */
     ...
     * @return null|string|array
     *
     * @link https://api.accounting.sh/swagger.html#operation/updateLink
     */
     ...
     * @return null|string|array
     *
     * @link https://api.accounting.sh/swagger.html#operation/viewLink
     */
