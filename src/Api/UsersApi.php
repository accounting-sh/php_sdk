...
class UsersApi
{
     ...
     * @return null|string|array
     *
     * @link https://api.accounting.sh/swagger.html#operation/deleteUser
     */
     ...
     * @param  string|\SplFileObject|null $avatar avatar (optional)
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return null|string|array
     *
     * @link https://api.accounting.sh/swagger.html#operation/updateMe
     */
    public function updateMe(
        string|null $name = null,
        string|\SplFileObject|null $avatar = null,
    ): null|string|array {
        ...
        if (is_string($avatar)) {
            if (file_exists($avatar)) {
                $avatar = new \SplFileObject($avatar);
            }
        }
        $options['multipart'][] = [
            'name' => "avatar",
        ...
        $query = http_build_query($queryParams);
        return $this->client->request("PATCH", $resourcePath . ($query ? "?{$query}" : ''), $options);
    }
