...
class AccountConnectionsApiTest extends TestCase
{
    ...
    public function testDeleteAccountConnection()
    {
        ...
        $path = str_replace('{' . 'connection' . '}', 'connection_example', $path);

        $api = new Accounting("fake-token", options: [
            'handler' => HandlerStack::create(new TestHandler("DELETE", $path, null, "fake-token"))
        ]);
        $this->assertNotNull($api->accountConnections()->deleteAccountConnection('uuid_example', 'connection_example', ));
    }
    ...
    /**
     * Test case for listConnectableBankAccounts
     *
     * List connectable bank accounts.
     *
     */
    public function testListConnectableBankAccounts()
    {
        ...
        $this->assertNotNull($api->accountConnections()->listConnectableBankAccounts('uuid_example', 'connection_example', ));
    }

    /**
     * Test case for listConnectedAccountTransactions
     *
     * List the connected account's transactions.
     *
     */
    public function testListConnectedAccountTransactions()
    {
        $path = "/accounts/{uuid}/connect/{connection}";
        $path = str_replace('{' . 'uuid' . '}', 'uuid_example', $path);
        $path = str_replace('{' . 'connection' . '}', 'connection_example', $path);
        ...
        $this->assertNotNull($api->accountConnections()->listConnectedAccountTransactions('uuid_example', 'connection_example', 3.4, ));
    }

    /**
     * Test case for requestBankConnection
     *
     * Request a new bank connection.
     *
     */
    public function testRequestBankConnection()
    {
        ...
        $this->assertNotNull($api->accountConnections()->requestBankConnection('uuid_example', ["test" => true], ));
    }

    /**
     * Test case for selectBankAccount
     *
     * Select a bank account to connect.
     *
     */
    public function testSelectBankAccount()
    {
        $path = "/accounts/{uuid}/connect/accounts";
        $path = str_replace('{' . 'uuid' . '}', 'uuid_example', $path);
        ...
        $this->assertNotNull($api->accountConnections()->selectBankAccount('uuid_example', ["test" => true], ));
    }
}
