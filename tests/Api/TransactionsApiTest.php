...
class TransactionsApiTest extends TestCase
{
    ...
    public function testAddLink()
    {
        ...
        $this->assertNotNull($api->transactions()->addLink(["test" => true], 'uuid_example', ));
    }
    ...
    public function testDeleteLink()
    {
        ...
        $path = str_replace('{' . 'uuid' . '}', 'uuid_example', $path);
        $path = str_replace('{' . 'link_uuid' . '}', 'linkUuid_example', $path);

        $api = new Accounting("fake-token", options: [
            'handler' => HandlerStack::create(new TestHandler("DELETE", $path, null, "fake-token"))
        ]);
        $this->assertNotNull($api->transactions()->deleteLink('uuid_example', 'linkUuid_example', ));
    }
    ...
    public function testLedger()
    {
        ...
        $this->assertNotNull($api->transactions()->ledger('fields_example', 'page_example', 'perPage_example', 'account_example', ));
    }
    ...
    public function testListLinks()
    {
        ...
        $this->assertNotNull($api->transactions()->listLinks('fields_example', 'page_example', 'perPage_example', 'uuid_example', ));
    }
    ...
    public function testUpdateLink()
    {
        ...
        $this->assertNotNull($api->transactions()->updateLink(["test" => true], 'uuid_example', 'linkUuid_example', ));
    }
    ...
    public function testViewLink()
    {
        ...
        $this->assertNotNull($api->transactions()->viewLink('uuid_example','linkUuid_example',));
    }
}
